...
//
// 戰場的**地形版面是原版的資料**：州郡記錄 offset 55–174 的 120 個
// 位元組，12 欄 × 10 列（`docs/spec/003` §3.3）。42 個郡 42 張，沒有
// 兩張相同。`internal/battle/generate.go` 的生成器留著當沒有劇本資料時
// 的退路，它是決定性的，所以走那條路的整場戰役
