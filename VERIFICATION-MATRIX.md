...
| 軍事與主戰場 | `mechanics/40` | `L0`（**戰場地圖**、地形碼、移動花費、地形攻守值、兵種適性、移動力、將領戰力值、交戰傷亡、發動戰役的流程、軍師勸諫、**六種計謀的費用／門檻／成功判定**、火攻水淹的地形殺傷、陷阱、燒糧、**電腦對電腦不進戰術層**：分岔條件、糧草消耗、戰力互削、勝負與傷亡寫回、**單挑的接受判定／拒絕損兵／回合與勝負**）／`L1`（電腦對電腦那條路真的沒跑日循環，5 場全數；**對戰子畫面兩版**：原版盤面丁整場、盤面己兩場單挑，加強版七張盤面含一場單挑，骰逐格相同）／`L2`（部隊層的合成、弓箭與圍攻的幅度）| `internal/battle` | 有 |
