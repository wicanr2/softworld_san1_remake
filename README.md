...
![遊戲主畫面](docs/images/main.png)

主畫面：四十二個郡、十類指令、事件紀錄。上圖是讓電腦跑六個月之後的
中平六年七月——秋收正好落在這個月（原版的四季常式一年各跑一次，
分派器比的是月份 1／4／7／10）。

![主戰場](docs/images/battle.png)

主戰場：六方向格子、九種地形、五種戰鬥隊伍、兩層指令。
地形版面是**原版的資料**（州郡記錄 offset 55–174，42 個郡 42 張）。

![英文介面](docs/images/main-en.png)

介面文字三個語系（繁中原文／英／日）。人名與郡名走**字元層**換寫：
英文用漢語拼音、日文換新字體，346 位人物 ＋ 42 個郡用到的 426 個相異字
都有涵蓋率測試盯著。
